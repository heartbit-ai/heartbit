        ...
        match action {
            CallbackAction::Approval {
                ...
                let decision = match decision.as_str() {
                    "allow" => heartbit::ApprovalDecision::Allow,
                    "always_allow" => heartbit::ApprovalDecision::AlwaysAllow,
...
mod tests {
    use super::*;
    use heartbit::InMemorySessionStore;
    ...
    async fn preload_memories_with_store() {
        use heartbit::{Confidentiality, InMemoryStore, MemoryEntry, MemoryType, NamespacedMemory};
    ...
    fn handle_callback_for_chat_resolves_approval() {
        ...
        assert_eq!(decision, heartbit::ApprovalDecision::Allow);
    }
