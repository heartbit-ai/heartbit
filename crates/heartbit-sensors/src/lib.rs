...
// ── Re-exported types from heartbit that sensor code needs ──────────────────

pub use heartbit::config::McpServerEntry;

// ── Re-exports from submodules ──────────────────────────────────────────────
pub use guardrail::SensorSecurityGuardrail;
pub use manager::SensorManager;
pub use metrics::SensorMetrics;

// ── Re-exported config types from heartbit ──────────────────────────────────
pub use heartbit::config::{
    SalienceConfig, SensorConfig, SensorModality, SensorRoutingConfig, SensorSourceConfig,
    StoryCorrelationConfig, TokenBudgetConfig, TrustLevel,
};

// ── Utility ─────────────────────────────────────────────────────────────────

/// Find the largest byte position <= `target` that is a valid UTF-8 char boundary.
