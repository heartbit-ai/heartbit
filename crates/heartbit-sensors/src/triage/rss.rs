...
use heartbit::llm::types::{CompletionRequest, Message, Role};

use crate::triage::{Priority, TriageDecision, TriageProcessor};
use crate::{SensorEvent, SensorModality};
    ...
    fn process(
        ...
        Box::pin(async move {
            ...
            let truncated = if content.len() > 2000 {
                let boundary = crate::floor_char_boundary(&content, 2000);
                &content[..boundary]
            } else {
                &content
            };
            ...
            let request = CompletionRequest {
                ...
                messages: vec![Message {
                    role: Role::User,
                    content: vec![heartbit::llm::types::ContentBlock::Text { text: prompt }],
                }],
                max_tokens: 200,
                tools: vec![],
                tool_choice: None,
            ...
            let text = response
                ...
                .find_map(|block| match block {
                    heartbit::llm::types::ContentBlock::Text { text } => Some(text.as_str()),
                    _ => None,
                })
                .unwrap_or("");
...
mod tests {
    use super::*;
    use heartbit::llm::types::{CompletionResponse, ContentBlock, StopReason, TokenUsage};
